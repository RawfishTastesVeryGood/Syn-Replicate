...
function resetmode()
	...
	coroutine.resume(coroutine.create(function()
		...
		pcall(function() Character.ReaperShadowHead.Eye1.BrickColor = BrickColor.new'Bright blue' end)
		pcall(function() Character.ReaperShadowHead.Eye2.BrickColor = BrickColor.new'Bright blue' end)
